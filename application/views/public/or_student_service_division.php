				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul style="padding:0;">
								<li><a href="<?= base_url()?>index.php/public/office_resource/office_school_director">Office of the School Director</a><i class="fa fa-play"></i></li>
								<li><a href="<?= base_url()?>index.php/public/office_resource">Academics Division</a><i class="fa fa-play"></i></li>
								<li class="dd active"><a href="<?= base_url()?>index.php/public/office_resource/student_service_division">Student Service Division</a><i class="fa fa-play"></i>
									<ul class="dropdown-menus"> 
										<li><a href="#osas">OSAS</a></li> 
										<li><a href="#or">Office of the Registrar</a></li> 
										<li><a href="#lirc">LIRC</a></li> 
										<li><a href="#go">Guidance Office</a></li> 
										<li><a href="#as">Alumni &amp; Scholarship</a></li> 
										<li><a href="#sce">Social Community Extension</a></li> 
										<li><a href="#sp">School Publication</a></li> 
									</ul>
					...
					<div class="col-md-13 pr-0">
						<div class="or bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">Student Service Division</h3>
							<div class="profile-info">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Student Service Division"):?>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							</div>
							<div class="mb-30" id="osas">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Office of the Student Affairs and Service (OSAS)"):?>
							...
							<div class="mb-30" id="or">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Office of the Registrar"):?>
										<h4 class="c-gray f-14"><?= $value->title?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							...
							<div class="mb-30" id="go">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Guidance Office"):?>
										<h4 class="c-gray f-14"><?= $value->title?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							...
							<div class="mb-30" id="as">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Alumni and Scholarship Office"):?>
										<h4 class="c-gray f-14"><?= $value->title?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							...
							<div class="mb-30" id="sce">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Social and Community Extension Office"):?>
										<h4 class="c-gray f-14"><?= $value->title?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							...
							<div class="mb-30" id="sp">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "School Publication Office"):?>
										<h4 class="c-gray f-14"><?= $value->title?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
