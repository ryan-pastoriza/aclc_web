	...
	<div class="main-content">
		<div class="container-fluid" style="width:90%;">
			...
			<div class="admission-main mb-30">
				<div class="row">
					<div class="col-md-24 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<div class="calendar-activity oh mb-30">
								<div class="head oh bb pb-10">
									<div class="col-md-24">
										<center><h1 class="normal c-gray f-20 mb-10">Your Registration is now for Verification</h3></center>
									</div>
									<div class="col-md-24">
										<h2>
											Please gave us 24 hours to verify your application and we will send you the following:
										</h2>
										<h3>
											1. Specific Date and time for your FIRST DAY OF CLASS in August.
										</h3>
										<h3>
											2. SCHEDULE OF CLASS and SCHOOL MAP for easy location of your classroom.
										</h3>
										<h3>
											3. After 48 hours you shall receive the Assessment of your enrollment.
										</h3>
										<h3>
											4. Notifications and updates from the school.
										</h3>
									</div>
								</div>
							</div>
