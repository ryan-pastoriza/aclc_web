				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul style="padding:0">
								...
								<li class="dd active"><a href="<?= base_url()?>index.php/public/office_resource">Academics Division</a><i class="fa fa-play"></i>
									<ul class="dropdown-menus"> 
										<li><a href="#ite">Information Technology Department</a></li> 
										<li><a href="#ba">Bussiness Administration</a></li> 
										<li><a href="#tv">Technical Vocation</a></li> 
										<li><a href="#lae">Liberal Arts Education</a></li> 
										<li><a href="#bed">Basic Education</a></li> 
									</ul>
					...
					<div class="col-md-13 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">Academic Division</h3>
							<div class="mb-40" id="ite">
								<?php foreach($info as $key => $value):?>
									<?php if($value->title == "Computer Education Department"): ?>
										<h4 class="c-gray f-14"><?= $value->title;?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							</div>
							<div class="mb-40" id="ba">
								<?php foreach($info as $key => $value):?>
									<?php if($value->title == "Business Administration Department"): ?>
										<h4 class="c-gray f-14"><?= $value->title;?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
							</div>
							<div class="mb-40" style="margin-bottom: 275px;" id="bed">
								<?php foreach($info as $key => $value):?>
									<?php if($value->title == "Basic Education Department"): ?>
										<h4 class="c-gray f-14"><?= $value->title;?></h4>
										<?= $value->content; ?>
									<?php endif;?>
								<?php endforeach; ?>
