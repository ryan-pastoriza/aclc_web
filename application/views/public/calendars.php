 ...
 * @Last Modified time: 2019-07-04 14:38:45
 */
?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="col-md-4 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul>
								...
								<li><a href="<?= base_url()?>index.php/public/sis/user_account">User Account</a><i class="fa fa-play"></i></li>
								<li><a href="<?= base_url()?>index.php/public/sis/enrollment">Enrollment</a><i class="fa fa-play"></i></li>
							</ul>
						</div>
					</div>
