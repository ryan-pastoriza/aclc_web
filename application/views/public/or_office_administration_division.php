				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul style="padding:0;">
								...
								<li class="dd active"><a href="<?= base_url()?>index.php/public/office_resource/office_administration_division">Office of Administration Division</a><i class="fa fa-play"></i>
									<ul class="dropdown-menus"> 
										<li><a href="#ta">Treasury And Accounting</a></li> 
										<li><a href="#ap">Assets and Properties</a></li> 
										<li><a href="#hr">Human Resources</a></li> 
										<li><a href="#ts">Technical Support</a></li>  
					...
					<div class="col-md-13 pr-0">
						<div class="or bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">Office of Administration Office</h3>
							<div class="profile-info">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Office of Administration Office"):?>
							...
							<div class="mb-30" id="ta">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Treasury and Accounting"):?>
										<div class="mb-30" id="qms">
							...
							<div class="mb-30" id="ap">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Assets and Properties"):?>
										<div class="mb-30" id="qms">
											<h4 class="c-gray f-14"><?= $value->title; ?></h4>
											<?= $value->content; ?>
										</div>
							...
							<div class="mb-30" id="hr">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Human Resource Management"):?>
										<div class="mb-30" id="qms">
											<h4 class="c-gray f-14"><?= $value->title; ?></h4>
											<?= $value->content; ?>
										</div>
							...
							<div class="mb-30" id="ts">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Technical Support"):?>
										<div class="mb-30" id="qms">
											<h4 class="c-gray f-14"><?= $value->title; ?></h4>
											<?= $value->content; ?>
										</div>
