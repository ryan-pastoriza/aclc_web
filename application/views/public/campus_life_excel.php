...
/**
 * @Author: Gian
 * @Date:   2018-06-25 08:30:11
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-07-31 11:36:16
 */
?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul>
								...
								<li class="active"><a href="<?= base_url()?>index.php/public/campus_life/excel">Excel</a><i class="fa fa-play"></i></li>
					...
					<div class="col-md-13 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">Excel <span class="pull-right" style="font-size:14px;"><a href="#" id="ae">About Excel </a> <a href="#" id="pub">Published</a></span></h3>
							<div id="about_excel">
								<div class="row">
									<div class="col-md-24">
										<?= $excel_about->detail ?>
								...
								<div class="row" style="margin-top:50px;">
									...
									<div class="col-md-24">
										<?php foreach($excel_pers_info as $key => $value): ?>
											<!-- <pre> -->
											<div class="row" style="padding-bottom:30px;">
												<div class="col-md-4">
													<img src="<?= base_url('plugins/images/excel_pers_info/'.$value->img)?>" alt="" style="width:100px;height:100px;">
												</div>
												<div class="col-md-20">
													<div class="row">
														<div class="col-md-24">
															<div class="row">
																<span style="font-size:20px;"><?= $value->fullname; ?></span><br />
															</div>
