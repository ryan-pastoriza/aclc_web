...
/**
 * @Author: Gian
 * @Date:   2018-08-09 09:11:08
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-09-06 09:46:57
 */
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <script type="text/javascript">
  	$(function(){
		...
		$(document).on('click','.more',function(e){
			$.ajax({
				url: '<?= base_url()?>index.php/public/campus_life/view_news',
				type: 'POST',
				dataType: 'JSON',
					...
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul>
								...
								<li class="active"><a href="<?= base_url()?>index.php/public/campus_life/news">News</a><i class="fa fa-play"></i></li>
							</ul>
						</div>
					</div>
					<div class="col-md-13 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">News</h3>
							<div id="about_excel">
								<div class="row">
																	...
																	<div class="row" style="margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			<?php if(!empty($value->image)): ?>
																				<h3 style="padding-bottom:10px;"><img src="<?= base_url()?><?= $value->image ?>" style="width:100px;height:100px;border-radius: 100%;"/> <?= ucwords($value->title)?></h3>
																			<?php else: ?>
																				<h3 style="padding-bottom:10px;"><img src="<?= base_url()?>plugins/images/no-image.jpg" style="width:100px;height:100px;border-radius: 100%;"/> <?= ucwords($value->title)?></h3>
																			<?php endif;?>
																			...
																			<a href="#" class="pull-right more" style="margin-right:10px;" attr="<?= $value->news_id ?>" >more...</a>
																		</div>
																	</div>
																</div>
															</div>
