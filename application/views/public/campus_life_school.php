				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul>
								<li class="active"><a href="<?= base_url()?>index.php/public/campus_life">School Activities</a><i class="fa fa-play"></i></li>
					...
					<div class="col-md-13 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">School Activities</h3>
							<div class="mb-40">
								<div class="calendar pt-10">
									<h5 class="c-gray">January</h5>
									<table class="table table-bordered c-gray f-11">
										<thead>
											<th class="center-text col-xs-5">Activity</th>
											<th class="center-text col-xs-4">Date</th>
											<th class="center-text col-xs-4">Time</th>
											<th class="center-text col-xs-6">Details</th>
											<th class="center-text col-xs-2">Department</th>
										</thead>
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Jan"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
														<td style="text-align:center;"><?= ucwords($value->details); ?></td>
														<td style="text-align:center;"><?= ucwords($value->department); ?></td>
													</tr>
												<?php endif; ?>
											<?php endforeach;?>
											<tr>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Feb"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Mar"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Apr"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "May"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Jun"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Jul"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Aug"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Sept"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Oct"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Nov"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
									...
									<table class="table table-bordered c-gray f-11">
										...
										<tbody>
											<?php foreach($sch_act as $key => $value):?>
												<?php if(date("Y",strtotime($value->date)) == date("Y") && date("M",strtotime($value->date)) == "Dec"): ?>
													<tr>
														<td style="text-align:center;"><?= ucwords($value->act_title); ?></td>
														<td style="text-align:center;"><?= ucwords(date("d - D")); ?></td>
														<td style="text-align:center;"><?= ucwords(date("H:i A")); ?></td>
