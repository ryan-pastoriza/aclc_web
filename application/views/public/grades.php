 ...
 * @Last Modified time: 2019-06-27 08:43:40
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>ACLC - Grades</title>
  <meta charset="utf-8">
										      ...
										      <div class="panel-body">
										      	<div class="col-md-24">
										      		...
										      		<div class="row" style="padding-bottom:25px;">
														<div class="col-md-24">
															<div class="col-md-24">
																<div class="row">
																	<center>
																		<h3 style="color:#00bcd4">BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATOR</h3>
																		<span style="color:#00bcd4">Major in Financial Management</span><br />
																		<span style="color:#00bcd4">Revised Curriculum Effectivity First Semester SY: <b>2015-2015</b></span>
																	</center>
																</div>
															</div>
														</div>
										      		...
										      		<table style="width:100%;" class="table table-bordered">
											      		<thead>
											      			<tr>
											      				<th style="text-align:center;background-color:#f0f0e1;">Subject Code</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Subject</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Prelim Grade</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Midterm Grade</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Pre-Final Grade</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Final</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Grade</th>
											      			</tr>
											      		</thead>
											      		<tbody >
											      			<tr>
