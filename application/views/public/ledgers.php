 ...
 * @Last Modified time: 2019-06-25 09:36:00
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>ACLC - Ledgers</title>
  <meta charset="utf-8">
								...
								<div class="col-md-24">
										      ...
										      <div class="panel-body">
										      	<div class="col-md-16">
										      		<table style="width:100%;" class="table table-bordered">
											      		<thead>
											      			<tr>
											      				<th style="text-align:center;background-color:#f0f0e1;">Official Receipt</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Amount</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Payment Date</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Cashier</th>
										      			...
										      			<tbody>
										      				<tr>
										      					<td>
										      						<table style="width:100%;">
										      							...
										      							<tr>
										      								<td> <span style="margin-left:50px;">Registration Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Guidance</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Medical / Dental Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Library Card</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">ID Validation (OLD)</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">SC / News Letter</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Student Service / Dev. Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Liberary Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Insurance Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Athletic Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Printing Cost</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      				...
										      				<tr>
										      					<td style="border-top:none !important;">
										      						<table style="width:100%;">
										      							<tr>
										      								<td> <span style="margin-left:50px;">Technology Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">MS Fee</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">E-Learning</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">Oracle</span></td>
										      								<td>452.00</td>
										      							</tr>
										      							<tr>
										      								<td> <span style="margin-left:50px;">NCC UK</span></td>
										      								<td>452.00</td>
										      							</tr>
										      						</table>
										      					</td>
										      				...
										      				<tr>
										      					<td style="border-top:none !important;">
										      						<table style="width:100%;">
										      							...
										      							<tr>
										      								<td> <span style="margin-left:50px;">Regular Subject</span></td>
										      								<td>452.00</td>
										      							</tr>
										      						</table>
										      					</td>
										      				...
										      				<tr>
										      					<td>
										      						<table style="width:100%;">
										      							<tr>
										      								<td> <span style="margin-left:50px;">Total</span></td>
										      								<td>452.00</td>
										      							</tr>
										      						</table>
										      					</td>
									...
									<div class="panel-group">
										<div class="panel panel-default">
										    <div class="panel-heading">
										      <h4 class="panel-title">
										        Academic Year : 2014-2015 &nbsp;&nbsp;&nbsp; Semester: 1st <a data-toggle="collapse" href="#collapse2" class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>
										      </h4>
										    </div>
