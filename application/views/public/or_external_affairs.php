				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul style="padding:0;">
								...
								<li class="dd active"><a href="<?= base_url()?>index.php/public/office_resource/external_affairs_and_special_projects_division"">External Affairs & Special Projects Division</a><i class="fa fa-play"></i>
									<ul class="dropdown-menus"> 
										<li><a href="#cm">Corporate Marketing</a></li> 
										<li><a href="#bl">Business Linkages</a></li> 
					...
					<div class="col-md-13 pr-0">
						<div class="or bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">External Affairs &amp; Special Project Division</h3>
							<div class="profile-info">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "External Affairs & Special Projects Division"):?>
							...
							<div class="mb-30" id="cm">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Corporate Marketing and External Affairs"):?>
										<div class="mb-30" id="qms">
							...
							<div class="mb-30" id="bl">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Business Linkages and Partnership Projects"):?>
										<div class="mb-30" id="qms">
											<h4 class="c-gray f-14"><?= $value->title; ?></h4>
											<?= $value->content; ?>
										</div>
							...
							<div class="mb-30" id="csr">
								<?php foreach($info as $key => $value): ?>
									<?php if($value->title == "Corporate Social Responsibility Project"):?>
										<div class="mb-30" id="qms">
											<h4 class="c-gray f-14"><?= $value->title; ?></h4>
											<?= $value->content; ?>
										</div>
