 ...
 * @Last Modified time: 2019-07-01 13:54:09
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>ACLC - Prospectus</title>
  <meta charset="utf-8">
										      	...
										      	<div class="col-md-24">
													...
													<center>
														...
														<?php foreach($arr as $val): ?>
															<h5 style="color:#00bcd4;"><?= $val ?></h5>
															<table style="width:100%;border:none !important;color:#00bcd4;">
																<thead>
																	<tr>
																		<th>Course</th>
																		<th>Title</th>
																		...
																		<th style="text-align: 	center;">Prerequisite</th>
																...
																<tbody>
																	<tr>
																		<td>GE111</td>
																		<td>English Communication Skills 1</td>
																	...
																	<tr>
																		<td>GE111</td>
																		<td>English Communication Skills 2</td>
																		<td style="text-align: 	center;">2</td>
																		<td style="text-align: 	center;">3</td>
																		<td style="text-align: 	center;">None</td>
																		<td style="text-align: 	center;">Done</td>
																	...
																	<tr>
																		<td>GE111</td>
																		<td>System Analysis Design 1</td>
																		<td style="text-align: 	center;">2</td>
																		<td style="text-align: 	center;">3</td>
																		<td style="text-align: 	center;">None</td>
																		<td style="text-align: 	center;">Done</td>
