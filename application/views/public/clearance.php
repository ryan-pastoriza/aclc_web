 ...
 * @Last Modified time: 2019-06-27 11:01:10
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>ACLC - Clearance</title>
  <meta charset="utf-8">
						...
						<div class="activity-sched bg-white ptb-15">
							<div class="calendar-activity oh mb-30">
								<div class="head oh bb pb-10">
									<h3 class="normal c-gray f-20 mb-10 pull-left">Clearance</h3>
								</div>
							</div>
							<div class="row">
								<div class="col-md-24">
										      ...
										      <div class="panel-body">
										      	<div class="col-md-24">
										      		...
										      		<table style="width:100%;" class="table table-bordered">
											      		<thead>
											      			<tr>
											      				<th style="text-align:center;background-color:#f0f0e1;">Signatory</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Department</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Position</th>
											      				<th style="text-align:center;background-color:#f0f0e1;">Status</th>
											      			</tr>
											      		</thead>
											      		<tbody >
											      			<tr>
											      				<td>Milagro Trace Morgan Hernandez</td>
											      				<td>IT Department</td>
											      				<td>Dean</td>
											      				<td>Cleared</td>
											      			</tr>
											      			<tr>
											      				<td>Jair Francisco Mallari Ramirez</td>
											      				<td>IT Department</td>
											      				<td>Dean</td>
											      				<td>Cleared</td>
											      			</tr>
											      			<tr>
											      				<td>Xander Josef Yulo Ancheta</td>
											      				<td>IT Department</td>
											      				<td>Dean</td>
											      				<td>Cleared</td>
											      			</tr>
