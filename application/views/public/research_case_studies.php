...
/**
 * @Author: Gian
 * @Date:   2018-06-11 14:07:54
 * @Last Modified by:   Gian
 * @Last Modified time: 2019-04-21 14:33:19
 */
?>
<?php
 ...
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-06-08 08:49:39
 */
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <script type="text/javascript">
  	$(function(){
		...
		$(document).on('click','.view-research',function(e){
	   		...
	   		$.ajax({
	   			url: '<?= base_url()?>index.php/public/research_case_study/retrieve_data',
	   			type: 'POST',
	   			dataType: 'JSON',
				...
				<div class="row" style="padding-bottom: 30px;">
					<div class="col-md-5 pr-0">
						<div class="admission-leftpane bg-white">
							...
							<ul>
								...
								<li class="active"><a href="<?= base_url()?>index.php/public/research_case_study">Case Studies</a><i class="fa fa-play"></i></li>
					...
					<div class="col-md-13 pr-0">
						<div class="activity-sched bg-white ptb-15">
							<h3 class="normal c-gray f-18 mb-15 bb pb-10">Thesis Research Studies</h3>
							<table class="research-table table" id="research-table">
								...
								<tbody>
									...
									<?php foreach($research as $key => $value):?>
										<tr>
											<td><a href="#" class="view-research" attr='<?= $value->cs_id ?>' style="text-decoration: none;"><?= $value->cs_id.". ". $value->title ?></a></td>
											<td style="text-align: center"><center><?= date("Y",strtotime($value->date_published))?></center></td>
											<td style="text-align: center"><center><a href="<?= base_url('plugins/images/research/case_studies/'.$value->cs_id)?>" target="_blank" download><?= $value->img_path !='' ? 'Download pdf':''?></a></center></td>
										</tr>
									<?php endforeach; ?>
								</tbody>
							</table>
