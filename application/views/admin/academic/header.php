 ...
 * @Last Modified time: 2018-08-20 14:35:09
 */
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav class="main-nav hidden-xs mb-10">
    <div class="container-fluid">
      <ul class="center-text inline-block">
        ...
        <li><a href="<?= base_url()?>index.php/admin/academics/academic_calendar" style="color:#ff003b8a !important;">Academics</a></li>
        ...
        <li><a href="<?= base_url()?>index.php/admin/campus_life/school_activites">Campus Life</a></li>
