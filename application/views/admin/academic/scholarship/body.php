...
/**
 * @Author: Gian
 * @Date:   2018-07-17 08:11:26
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-08-28 10:05:08
 */
$this->load->view('admin/academic/scholarship/jscripts');
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
		            ...
		            <li class="active"><a href="<?= base_url()?>index.php/admin/academics/scholarships">Scholarship</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Scholarships</h3>
				<div class="row">
					<div class="col-md-10">
						<?php echo form_open_multipart('admin/academics/scholarships/save_scholar',array('id'=>'form-text-sch' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
						  	<input type="text" name="scholarship_id" id="scholarship_id" hidden>
							...
							<div class="form-group">
								<button class="btn btn-primary pull-right" style="padding-top:5px;margin-bottom: 5px;margin-top:10px;" id="btn-save">Save</button>
							</div>
						</form>
					</div>
					<div class="col-md-14">
																...
																<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
																	<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			...
																			<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->scholarship_id ?>">modify</a>
																		</div>
																	</div>
																</div>
															</div>
