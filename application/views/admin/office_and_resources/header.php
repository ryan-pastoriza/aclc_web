 ...
 * @Last Modified time: 2018-08-20 14:35:13
 */
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav class="main-nav hidden-xs mb-10">
    <div class="container-fluid">
      <ul class="center-text inline-block">
        ...
        <li><a href="<?= base_url()?>index.php/admin/office_and_resources/office_of_the_school_director" style="color:#ff003b8a !important;">Offices and Resources</a></li>
