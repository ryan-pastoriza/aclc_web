 ...
 * @Last Modified time: 2018-06-07 09:59:18
 */
$this->load->view("admin/office_and_resources/student_service_division/scripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
		            ...
		            <li class="active"><a href="<?= base_url()?>index.php/admin/office_and_resources/student_service_division">Student Service Division</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Student Service Division</h3>
				<div class="row">
					<div class="col-md-10">
						<?php echo form_open_multipart('admin/office_and_resources/student_service_division/save_text',array('id'=>'form-text-ssd' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
							...
							<div class="form-group">
								...
								<input type="text" name="ssd_id" id="ssd_id" class="hidden">
							</div>
							<div class="form-group">
										...
										<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
											<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
												<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
													...
													<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->ssd_id ?>">modify</a>
												</div>
											</div>
										</div>
									<?php endforeach;?>
