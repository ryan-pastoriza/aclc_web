...
/**
 * @Author: Gian
 * @Date:   2018-04-17 00:50:41
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-06-07 11:36:07
 */
?>
<script>
$(function(){
	   ...
	   $(document).on('click','.edit',function(e){
	   		...
	   		$.ajax({
	   			url: '<?= base_url()?>index.php/admin/office_and_resources/student_service_division/retrieve_data',
	   			type: 'POST',
	   			dataType: 'JSON',
	   ...
	   $('#form-text-ssd').ajaxForm(options);
	});
</script>
<style type="text/css">
