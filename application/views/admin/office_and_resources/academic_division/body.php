 ...
 * @Last Modified time: 2018-05-10 10:09:10
 */
$this->load->view("admin/office_and_resources/academic_division/jscripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
        			<li ><a href="<?= base_url()?>index.php/admin/office_and_resources/office_of_the_school_director">Office of the School Director</a><i class="fa fa-play"></i></li>
		            <li class="active"><a href="<?= base_url()?>index.php/admin/office_and_resources/academic_division">Academic Division</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Academic Division</h3>
				<div class="row">
					<div class="col-md-10">
						<?php echo form_open_multipart('admin/office_and_resources/academic_division/save_text',array('id'=>'form-text-ad' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
										...
										<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
											<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
												<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
													...
													<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->ad_id ?>">modify</a>
												</div>
											</div>
										</div>
									<?php endforeach;?>
