 ...
 * @Last Modified time: 2019-04-23 09:07:46
 */
$this->load->view("admin/research/reid/jscripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
        			<li class="active"><a href="<?= base_url()?>index.php/admin/research/ried">Ried Multidisciplinary Research Journal</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Ried Multidisciplinary Research Journal</h3>
				<div class="row">
					<div class="col-md-10">
						
						<?php echo form_open_multipart('admin/research/ried/save_text',array('id'=>'form-text-caps' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
						  	<input type="text" name="ried_id" id="caps_id" hidden>
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<label for="title" style="font-weight: normal;" class="c-gray">Upload Cover</label>
									<input type="file" name="cover-file" id="cover" class="form-control" style="border-radius:0;">
								</div>
							</div>
							<div class="form-group">
																...
																<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
																	<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			...
																			<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->ried_id ?>">modify</a>
																		</div>
																	</div>
																</div>
															</div>
