 ...
 * @Last Modified time: 2019-04-21 13:33:08
 */
$this->load->view("admin/research/case_studies/jscripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
		            ...
		            <li class="active"><a href="<?= base_url()?>index.php/admin/research/case_studies">Case Studies</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Case Studies</h3>
				<div class="row">
					<div class="col-md-10">
						<?php echo form_open_multipart('admin/research/case_studies/save_text',array('id'=>'form-text-cs' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
						  	<input type="text" name="cs_id" id="cs_id" hidden>
																...
																<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
																	<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			...
																			<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->cs_id ?>">modify</a>
																		</div>
																	</div>
																</div>
															</div>
				...
				<div class="row">
					<div class="col-md-24">
						<?php echo form_open_multipart('admin/research/case_studies/about_case',array('id'=>'form-text-about-case' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
							<input type="text" name="abcase_id" id="abcase_id" value="<?= !empty($abc->abcase_id) ? $abc->abcase_id :''?>" hidden>
							<div class="form-group">
								<label for="content" style="font-weight: normal;" class="c-gray"><h3>About Case Studies</h3></label>
