...
/**
 * @Author: Gian
 * @Date:   2018-04-17 02:01:03
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-11-22 15:34:53
 */
?>
<script>
$(function(){
	   ...
	   $('#form-text-about-case').ajaxForm(options1);

	   $(document).on('click','.edit',function(e){
	   		// alert("under construction!");
	   		$.ajax({
	   			url: '<?= base_url()?>index.php/admin/research/case_studies/retrieve_data',
	   			type: 'POST',
	   			dataType: 'JSON',
