 ...
 * @Last Modified time: 2018-12-19 11:10:30
 */
$this->load->view("admin/research/capstone/jscripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
        			<li class="active"><a href="<?= base_url()?>index.php/admin/research/capstone">Capstone</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">Capstone</h3>
				<div class="row">
					<div class="col-md-10">
						
						<?php echo form_open_multipart('admin/research/capstone/save_text',array('id'=>'form-text-caps' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
						  	<input type="text" name="caps_id" id="caps_id" hidden>
																...
																<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
																	<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			...
																			<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->caps_id ?>">modify</a>
																		</div>
																	</div>
																</div>
															</div>
				...
				<div class="row">
					<div class="col-md-24">
						<?php echo form_open_multipart('admin/research/capstone/about_capstone',array('id'=>'form-text-about-cap' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
