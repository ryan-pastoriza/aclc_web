 ...
 * @Last Modified time: 2019-04-21 13:54:22
 */
$this->load->view("admin/research/rmrj/jscripts");
?>
    ...
    <div class="row">
      	<div class="col-md-4 pr-0">
        	<div class="admission-leftpane bg-white">
      			...
      			<ul>
        			...
        			<li class="active"><a href="<?= base_url()?>index.php/admin/research/rmrj">RMRJ Book and Abstract</a><i class="fa fa-play"></i></li>
		            ...
		            <li><a href="<?= base_url()?>index.php/admin/research/thesis">Thesis</a><i class="fa fa-play"></i></li>
		            <li><a href="<?= base_url()?>index.php/admin/research/case_studies">Case Studies</a></li>
		            <li><a href="<?= base_url()?>index.php/admin/research/institutional">Institutional</a><i class="fa fa-play"></i></li>
    	...
    	<div class="col-md-20">
			<div class="mid-content ptb-15 bg-white oh">
				<h3 class="normal c-gray f-20 mb-15 bb pb-10">RMRJ Book and Abstract</h3>
				<div class="row">
					<div class="col-md-10">
						
						<?php echo form_open_multipart('admin/research/rmrj/save_text',array('id'=>'form-text-caps' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
						  	<input type="text" name="rmrj_id" id="caps_id" hidden>
							...
							<div class="form-group">
								<!-- <label class="btn btn-primary pull-right" id="btn-file">
					                Upload Excel File <input type="file" style="display: none;" name="files_data" accept="application/pdf">
					            </label> -->
																...
																<div style="border-bottom:1px solid #dfdfd0;padding-bottom:10px;margin-top:10px;">
																	<div class="row" style="border-left:20px solid #dfdfd0;margin-left:20px;">
																		<div class="col-md-24" style="padding-left:10px;word-wrap:break-word;">
																			...
																			<a href="#" class="pull-right edit" style="margin-right:10px;" attr="<?= $value->rmrj_id ?>">modify</a>
																		</div>
																	</div>
																</div>
															</div>
				...
				<!-- <div class="row">
					<div class="col-md-24">
						<?php echo form_open_multipart('admin/research/rmrj/about_capstone',array('id'=>'form-text-about-cap' , 'class' => 'form-horizontal', 'data-toggle' => "validator", 'method' => "post")) ?>
							<input type="text" name="abcap_id" id="abcap_id" value="<?= !empty($abc->abcap_id) ? $abc->abcap_id :''?>" hidden>
							<div class="form-group">
								<label for="content" style="font-weight: normal;" class="c-gray"><h3>About Capstone</h3></label>
								<textarea name="content" id="cont"><?= !empty($abc->details) ? $abc->details:"" ?></textarea>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-primary pull-right" style="padding-top:5px;margin-bottom: 5px;margin-top:10px;" id="btn-saved">Save</button>
							</div>
						</form>
					</div>
				</div> -->
