...
/**
 * @Author: Gian
 * @Date:   2018-04-17 02:06:44
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-06-17 09:27:36
 */
?>
<script>
$(function(){
	   ...
	   $(document).on('click','.edit',function(e){
	   		...
	   		$.ajax({
	   			url: '<?= base_url()?>index.php/admin/research/institutional/retrieve_data',
	   			type: 'POST',
	   			dataType: 'JSON',
	   ...
	   $('#form-text-ins').ajaxForm(options);
	});
</script>
<style type="text/css">
