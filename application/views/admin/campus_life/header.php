...
/**
 * @Author: Gian
 * @Date:   2018-01-26 11:48:22
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-08-20 14:35:11
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url()?>plugins/plugins/fileinput/css/fileinput.min.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url()?>plugins/plugins/fileinput/css/fileinput-rtl.min.css">
  ...
  <script src="<?= base_url()?>plugins/plugins/fileinput/js/fileinput.min.js"></script>
  ...
  <nav class="main-nav hidden-xs mb-10">
    <div class="container-fluid">
      <ul class="center-text inline-block">
        ...
        <li><a href="<?= base_url()?>index.php/admin/campus_life/school_activities" style="color:#ff003b8a !important;">Campus Life</a></li>
