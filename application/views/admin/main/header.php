...
/**
 * @Author: Gian
 * @Date:   2018-07-08 10:16:48
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-08-31 14:44:37
 */
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav class="main-nav hidden-xs mb-10">
    <div class="container-fluid">
      <ul class="center-text inline-block">
        <li><a href="<?= base_url()?>index.php/admin/main/main_page" style="color:#ff003b8a !important;">Main</a></li>
